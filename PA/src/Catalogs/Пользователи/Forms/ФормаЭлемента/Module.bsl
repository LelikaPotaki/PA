...
Процедура УправлениеДоступностьюЭлементовФормы(Форма)
	...
	Элементы.Логин.Доступность = УправлениеПользователемДоступно;
	Элементы.ГруппаПароль.Доступность = УправлениеПользователемДоступно;
	Элементы.РольПользователя.Доступность = УправлениеПользователемДоступно;
	Элементы.Логин.Доступность = УправлениеПользователемДоступно;
