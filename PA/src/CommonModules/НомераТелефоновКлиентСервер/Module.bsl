...
// Преобразует номер телефона из лююбого формата в нормализованный для быстрого поиска.
// Нормализованный номер телефона состоит из 11 цифр и начинается с 7.
// 
// Параметры:
...
Функция НормализованныйНомерТелефона(Телефон, ВызыватьИсключение = Ложь) Экспорт
	...
	Если Не СтрДлина(ЦифрыТелефона) Тогда
