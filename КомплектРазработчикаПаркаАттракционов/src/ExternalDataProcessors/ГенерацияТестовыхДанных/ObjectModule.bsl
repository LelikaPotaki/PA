...
Процедура СформироватьПосещенияПосетителя(Посетитель, ДатаПосещения, СписокАттракционов, ГСЧ = Неопределено)
	...
	Для Сч = 1 По КоличествоАттракционов Цикл
		ИндексАттракциона = ГСЧ.СлучайноеЧисло(0, СписокАттракционов.Количество() - 1);
...
// 
// Параметры:
//  Посетитель - СправочникСсылка.Клиенты
//  Аттракцион - СправочникСсылка.Аттракционы
//  ДатаПосещения - Дата
...
// 
// Возвращаемое значение:
//  Неопределено, ДокументСсылка.ПосещениеАттракциона - Текущее основание
Функция ТекущееОснование(Посетитель, Аттракцион)
	...
	Если Выборка.Следующий() Тогда
		Основание = Выборка.Основание; // ДокументСсылка.ПосещениеАттракциона
		Возврат Основание;
	КонецЕсли;
